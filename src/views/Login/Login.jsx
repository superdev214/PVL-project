    ...
    <div>
      ...
      <div className="bg-[#2B2B2B]">
        <div className="container pt-[80px] mx-auto px-[30px] md:grid md:grid-cols-2 md:gap-x-10">
          ...
          <div>
            {/* header */}
            <div className="my-[30px] md:max-w-[330px] xl:max-w-[460px]">
            ...
            <form className="pb-10 md:max-w-[330px] xl:min-w-[330px] space-y-[15px]">
              <div class="flex items-center text-lg">
                ...
                <input
                  type="text"
                  id="inputUsername"
                  class="bg-white pl-12 py-2 md:py-4 focus:outline-none w-full rounded-[20px] placeholder:font-work placeholder:text-base placeholder:leading-[22px] placeholder:text-black "
