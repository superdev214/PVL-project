      ...
      <ScrollAnimationWrapper>
        <motion.div variants={scrollAnimation} className="bg-[#2B2B2B]">
          <div className="container pt-[80px] mx-auto px-[30px] md:grid md:grid-cols-2 md:gap-x-10">
            ...
            <div>
              {/* header */}
              <motion.div variants={variants} className="my-[30px] md:max-w-[330px] xl:max-w-[460px]">
              ...
              <form className="pb-10 md:max-w-[330px] xl:min-w-[330px] space-y-[15px]">
                <motion.div  variants={variants_items} className="flex items-center text-lg">
                  <svg
                ...
                <motion.div  variants={variants_items} className="flex items-center text-lg mb-6 md:mb-8">
                  <svg className="absolute ml-3" viewBox="0 0 24 24" width="24">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
