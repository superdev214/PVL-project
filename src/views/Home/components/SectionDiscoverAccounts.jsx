...
const SectionDiscoverAccount = () => {
  ...
  return (
    <ScrollAnimationWrapper>
      <motion.div  className="bg-[#2B2B2B] mt-16">
        <motion.div variants={scrollAnimation} className="container mx-auto py-10 md:py-[80px] w-full grid md:grid-cols-2 gap-x-[30px] px-8  md:px-12 xl:px-[130px] 2xl:px-[195px] ">
