    ...
    <ScrollAnimationWrapper>
      ...
      >
        <div
          style={{
            background:
              "linear-gradient(180deg, rgba(162, 89, 255, 0.00) 0%, #A259FF 100%)",
          }}
        >
          <motion.div
            variants={scrollAnimation}
            className="container mx-auto px-8 pt-[120px] pb-[40px] space-y-10 md:px-12 xl:px-[130px] 2xl:px-[195px] md:pt-[360px] md:pb-[60px]"
          >
